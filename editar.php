<?php
// editar.php – Editar un producto existente (UPDATE)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Si hay error, mantener los valores enviados en el form
...
<div class="d-flex">
    ...
    <main class="flex-grow-1 p-4">
        <div class="mb-4">
            ...
            <p class="text-muted small">Modifica los datos del producto <strong>#<?= $id ?></strong></p>
        </div>
